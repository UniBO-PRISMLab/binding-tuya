...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, schema, body, write, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                client = new http_1.HttpClient({ allowSelfSigned: true }, true);
                schema = {
            ...
            case 1: return [4 /*yield*/, (_c.sent()).body];
            case 2: return [4 /*yield*/, (_c.sent()).toString()];
            case 3:
                _b.apply(_a, [_c.sent()]);
                return [2 /*return*/];
        }
